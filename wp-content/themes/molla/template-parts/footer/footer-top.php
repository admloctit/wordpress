<?php
$cols        = molla_option( 'footer_top_cols' );
...
if ( $active ) :
	?>
<div class="footer-top<?php echo esc_attr( molla_option( 'footer_top_divider_active' ) ? ( molla_option( 'footer_top_divider_width' ) ? ' full-divider' : ' content-divider' ) : '' ); ?>">
