...
function molla_scripts() {
	...
	wp_register_script( 'jquery-elevateZoom', MOLLA_JS . '/plugins/jquery.elevatezoom.min.js', array(), '3.0.8', true );
	...
	wp_register_script( 'jquery-parallax', MOLLA_JS . '/plugins/jquery.parallax.js', array(), true, true );
	...
	wp_enqueue_script( 'molla-sticky', MOLLA_JS . '/sticky.min.js', array( 'jquery' ), MOLLA_VERSION, true );
	wp_enqueue_script( 'molla-main', MOLLA_JS . '/main.min.js', array( 'jquery' ), MOLLA_VERSION, true );
