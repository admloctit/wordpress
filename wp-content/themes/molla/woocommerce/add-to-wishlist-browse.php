...
<?php if ( apply_filters( 'molla_wishlist_browse_feedback_enable', false ) ) : ?>
	<span class="feedback">
		<?php echo molla_strip_script_tags( $icon ); ?>
		<?php echo esc_html( $already_in_wishslist_text ); ?>
	</span>
<?php endif; ?>
	<a href="<?php echo esc_url( $wishlist_url ); ?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ); ?>" class="<?php echo esc_attr( apply_filters( 'molla_browse_wishlist_class', 'browse_to_wishlist' ) ); ?>">
