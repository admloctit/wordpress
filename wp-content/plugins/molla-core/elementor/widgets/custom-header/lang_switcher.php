...
/**
 * Molla Elementor Header Language Switcher Widget
 *
 *
 * @since 1.2
 */
...
class Molla_Custom_Header_Lang_Switcher_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'molla_lang_switcher';
	}

	public function get_title() {
		return esc_html__( 'Molla Language Switcher', 'molla-core' );
	}
	...
	public function get_keywords() {
		return array( 'header', 'switcher', 'language', 'multi', 'price', 'usd', 'euro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_item_style',
			array(
				'label' => esc_html__( 'Language item', 'molla-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function render() {
		...
		if ( defined( 'MOLLA_VERSION' ) ) {
			molla_get_template_part( 'template-parts/header/elements/lang_switcher', null );
		}
	}
}
