...
add_filter( 'woocommerce_single_product_image_thumbnail_html', 'molla_single_product_image_thumbnail_html', 10, 3 );
// Single product label
remove_action( 'woocommerce_before_single_product_summary', 'woocommerce_show_product_sale_flash', 10 );
add_action( 'molla_woocommerce_after_single_image', 'woocommerce_show_product_loop_sale_flash', 10 );
...
add_filter( 'woocommerce_get_privacy_policy_text', 'molla_account_privacy_policy_text', 2 );
