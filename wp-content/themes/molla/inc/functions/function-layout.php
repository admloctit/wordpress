...
if ( ! function_exists( 'molla_404_page' ) ) :
	function molla_404_page() {
		...
		<div class="error-page-content text-center">
			...
			<a href="<?php echo esc_url( home_url() ); ?>" class="btn btn-rect btn-outline btn-primary btn-md "><span><?php esc_html_e( 'BACK TO HOMPEAGE', 'molla' ); ?></span><i class="icon-long-arrow-right"></i></a>
		</div>
		<?php
		echo ob_get_clean();
	}
