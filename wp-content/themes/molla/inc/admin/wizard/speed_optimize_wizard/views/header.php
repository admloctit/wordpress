<div class="wrap molla-wrap molla-wizard molla-speed-wizard">
	<h2 class="screen-reader-text"><?php esc_html_e( 'Speed Optimize Wizard', 'molla' ); ?></h2>
	<div class="molla-admin-panel">
		<div class="molla-admin-panel-header">
			<div class="panel-header-left">
				<h1><?php esc_html_e( 'Speed Optimize Wizard', 'molla' ); ?></h1>
				<p><?php esc_html_e( 'Molla speed optimize wizard will help you configure proper website with optimum css & js.', 'molla' ); ?></p>
			</div>
