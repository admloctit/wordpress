...
<div class="<?php echo esc_attr( $page_width ) . esc_attr( $sidebar['active'] ? ( ' ' . $sidebar['pos'] . '-sidebar' ) : '' ) . ( $sticky_sidebar ? '' : ' toggle-sidebar' ) . ( ! woocommerce_product_loop() ? ' empty-archive' : '' ); ?>">
