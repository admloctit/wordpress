...
$attributes      = apply_filters( 'molla_single_product_attrs_available', $attributes );
				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
						<tr>
							...
							<td class="value">
								...
								do_action( 'molla_woocommerce_product_listed_attrs', array( $attribute_name => $options ), $pick_tax );
