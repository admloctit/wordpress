...
(function (theme, $) {
    ...
    PluginSectionScroll.prototype = {
        ...
        build: function () {
            ...
            // Make footer scrollable section whether exists scrollable section
            if ($('.section-scroll').length) {
                $('footer').addClass('section-scroll');
            }
            ...
            $('.section-scroll').wrap('<div class="section-wrapper"></div>');
            ...
            var process_scroll = function (e) {
                if ($(e.srcElement).closest('.menu').length ||
                    $(e.srcElement).closest('.mobile-menu').length ||
                    $(e.srcElement).closest('.live-search-list').length) {
                ...
                if (!flag && !scrollableFlag) {
                    ...
                    setTimeout(function () {
                        ...
                        self.$header.trigger('molla_section_scroll_scrolled', [self.getCurrentIndex()]);
        ...
        updateSectionsHeight: function () {
            ...
            $('.section-scroll').each(function () {
                ...
                if ($(this).outerHeight() < (window.innerHeight + 3)) {
                    $(this).removeClass('section-scroll-scrollable');
        ...
        changeDotsActiveState: function () {
            ...
            $('.section-scroll-nav > ul > li').removeClass('active');
            $('.section-scroll-nav > ul > li').eq(self.getCurrentIndex()).addClass('active');
        ...
        dotsNavigation: function () {
            ...
            var dotsNav = $('<div class="section-scroll-nav"><ul class="list list-unstyled"></ul></div>'),
                currentSectionIndex = self.getCurrentIndex();

            for (var i = 0; i < $('.section-scroll').length; i++) {
                var $section = $('.section-wrapper').eq(i).find('.section-scroll'),
                    title = $section.data('section-tooltip');
                if (!title) {
                    title = 'Section ' + $section.data('id');
                }
    ...
    // jquery plugin
    $.fn.themePluginSectionScroll = function () {
        return this.map(function () {
            ...
            if ($this.data(instanceName)) {
                ...
                return new PluginSectionScroll($this);
            }
