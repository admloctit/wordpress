...
(function( $, window, document, undefined ) {
    var ElevateZoom = {
            init: function( options, elem ) {
                ...
                self.elem = elem;
                self.$elem = $( elem );
                self.imageSrc = self.$elem.attr("data-zoom-image") ? self.$elem.attr("data-zoom-image") : ( self.$elem.attr("href") ? self.$elem.attr("href") : ( self.$elem.data("original") ? self.$elem.data("original") : self.$elem.attr("src") ) );
